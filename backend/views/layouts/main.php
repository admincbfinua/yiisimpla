                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> <?php echo \Yii::t('/yii','Menu')?> <span class="fa fa-chevron-down"></span></a>
                    <ul style="display:block;" class="nav child_menu">
                      ...
                      <li><a href="<?php echo Url::to(['lang/index']);?>"><?php echo \Yii::t('/yii','Language site. Create');?></a></li>
					  <li><a href="<?php echo Url::to(['menu/index']);?>"><?php echo \Yii::t('/yii','Create menu struchere');?></a></li>
                      <li><a href="<?php echo Url::to(['page/index']);?>"><?php echo \Yii::t('/yii','Create page');?></a></li>
